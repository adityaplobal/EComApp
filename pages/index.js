...
export default function Home() {
  return (
    ...
    <div>
      ...
      <main>
        {/* <img src="/bat.jpeg" alt="Descriptive alt text" layout="fill" objectFit="cover"
            priority></img> */}
        <div>
          <Image 
          src="/bat.jpeg" 
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores nisi sunt placeat tenetur blanditiis? </p>
    </div>
...
// ctrl+spacebar to enable tailwind css extension if not working even after you type mx-