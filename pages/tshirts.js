  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
        ...
        <a href={'/product/wear-the-code'}  className="block relative  rounded overflow-hidden">
          {/* <img alt="ecommerce" className="m-auto md:mx-0 h-[30vh] md:h-[36vh] block" src="https://m.media-amazon.com/images/I/61QrEBAY5EL._SY879_.jpg" /> */}
          <img alt="ecommerce" className="m-auto md:mx-0 h-[36vh] md:h-[36vh] block" src="https://m.media-amazon.com/images/I/61QrEBAY5EL._SY879_.jpg" />
        </a>
